...
const char INTL_RELAY[] PROGMEM = "Relay";
const char INTL_STATUS[] PROGMEM = "Status";
const char INTL_PH_WERT[] PROGMEM = "PH Wert";
const char INTL_PH_CALIBRATE_M[] PROGMEM = "SEN0161 Kalibr. M";
const char INTL_PH_CALIBRATE_B[] PROGMEM = "SEN0161 Kalibr. B";
const char INTL_BUTTON[] PROGMEM = "Button"; 
...
const char INTL_HOLEN_VON[] PROGMEM = "Holen von {v}"; 
const char INTL_HTTP_FREMDAPI_URL[] PROGMEM = "Api-Airrohr-Sensor"; 
